...
export default function ViewCustomers() {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await axios.get(
        "https://muzic-h1kw3ki9l-yugasaimanikantas-projects.vercel.app/viewcustomers"
      );
  ...
  const deleteCustomer = async (email) => {
    try {
      await axios.delete(
        `https://muzic-h1kw3ki9l-yugasaimanikantas-projects.vercel.app/deletecustomers/${email}`
      );
